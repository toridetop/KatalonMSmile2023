...
Mobile.callTestCase(findTestCase('Test Cases/Desktop - Host UAT/TC - Cek Host Saldo Sumber-OK'), null)
GlobalVariable.SaldoAwalSumber = GlobalVariable.SaldoFinalSumber
//
////--------------------------------------------------------------------------------------------------------------------------
//
...
Mobile.callTestCase(findTestCase('Test Cases/Desktop - Host UAT/TC - Cek Host Saldo Sumber-OK'), null)
GlobalVariable.SaldoAkhirSumber = GlobalVariable.SaldoFinalSumber

Mobile.callTestCase(findTestCase('Test Cases/Desktop - Host UAT/TC - Hitung Saldo Sumber-OK'), null)
