...
Mobile.tap(findTestObject('Object Repository/Menu Top Up/OR-PaketData-Indosat/android.widget.Image - arrow-down-jenis-paket'), 
    0)
...
Mobile.waitForElementPresent(findTestObject('Object Repository/Menu Top Up/OR-PaketData-Indosat/txt - Pembelian Berhasil'), 
    0)

Mobile.verifyElementText(findTestObject('Object Repository/Menu Top Up/OR-PaketData-Indosat/txt - Pembelian Berhasil'), 
    'Pembelian Berhasil')
...
Mobile.verifyElementText(findTestObject('Object Repository/Menu Top Up/OR-PaketData-Indosat/byadm - Rp. 1.500'), 'Rp. ' + 
    adm)
...
Mobile.verifyElementText(findTestObject('Object Repository/Menu Top Up/OR-PaketData-Indosat/total - Rp. 51.500'), 'Rp. ' + 
    tot)

//------------------------------------------------------------------------------------------------------------------------

String nominal1 = Mobile.getText(findTestObject('Object Repository/Menu Top Up/OR-PaketData-Indosat/total - Rp. 51.500'), 0)

String tanpaRp = nominal1.substring(nominal1.indexOf('Rp') + 3)
println(tanpaRp)

String hapusspasi = tanpaRp.replaceAll(' ', '')
println(hapusspasi)

String hapustitik = tanpaRp.replace('.', '')
println(hapustitik)

GlobalVariable.NominalTrx = hapustitik
