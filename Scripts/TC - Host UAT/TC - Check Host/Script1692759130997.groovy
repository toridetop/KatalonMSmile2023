...
Windows.setText(findWindowsObject('Object Repository/HOST UAT/Edit'), 'SENTOT')

Windows.click(findWindowsObject('Object Repository/HOST UAT/Edit(1)'))

Windows.setText(findWindowsObject('Object Repository/HOST UAT/Edit(1)'), 'RENTAL61')
...
Windows.verifyElementAttributeValue(findWindowsObject('Object Repository/HOST UAT/Pane'), 'User', 'User', 0)
