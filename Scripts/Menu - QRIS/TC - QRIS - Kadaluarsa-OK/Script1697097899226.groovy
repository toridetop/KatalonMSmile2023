...
Mobile.setText(findTestObject('Object Repository/QRIS/android.widget.EditTextNominal (1)'), '12345', 0)
...
Mobile.verifyElementExist(findTestObject('Object Repository/QRIS/android.widget.TextView - QR Code sudah kadaluwarsa. Silakan ulangi transaksi kembali. QR57'), 5)

Mobile.delay(1)

Mobile.tap(findTestObject('Object Repository/QRIS/android.widget.Button - OK'), 0)